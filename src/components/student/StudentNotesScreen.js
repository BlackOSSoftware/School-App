    ...
    () => (
      <>
        <View style={styles.headerRow}>
          <AppIcon name="document-text-outline" size={18} color={colors.student.textPrimary} />
      ...
      <Animated.View style={[styles.detailContainer, { opacity: fadeAnim, transform: [{ translateY: translateAnim }] }]}>
        <View style={styles.topBar}>
          ...
          <View style={styles.topTitleWrap}>
            <AppIcon name="document-text-outline" size={16} color={colors.student.textPrimary} />
